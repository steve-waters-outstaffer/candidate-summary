...
from helpers import (
    ...
    fetch_recruitcrm_candidate_job_specific_fields # Make sure to import the new function
)
...
def generate_multiple_candidates():
    ...
    try:
        ...
        for i, slug in enumerate(candidate_slugs):
            ...
            # New: Fetch and merge job-specific fields
    ...
    try:
        ...
        for cand_info in candidates:
            ...
            try:
                ...
                job_specific_fields = fetch_recruitcrm_candidate_job_specific_fields(slug, job_slug)
                if job_specific_fields:
                    if 'custom_fields' in full_candidate_data:
                        full_candidate_data['custom_fields'].extend(job_specific_fields)
                    else:
                        full_candidate_data['custom_fields'] = job_specific_fields
