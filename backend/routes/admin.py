...
def list_prompts():
    ...
    try:
        ...
        return jsonify({'success': False, 'error': 'Failed to retrieve prompt list'}), 500
...
def get_prompt(prompt_id):
    try:
        ...
        return jsonify({'success': False, 'error': 'Failed to retrieve prompt'}), 500
...
def get_webhook_config():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to retrieve webhook configuration'}), 500
...
def get_summary_runs():
    ...
    try:
        ...
        return jsonify({'success': False, 'error': 'Failed to retrieve summary runs'}), 500