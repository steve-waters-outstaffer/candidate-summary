...
def get_prompt(prompt_id):
    try:
        ...
        return jsonify({'success': False, 'error': 'An internal error occurred while fetching prompt'}), 500
...
def create_prompt():
    try:
        ...
        return jsonify({'success': False, 'error': 'An internal error occurred while creating prompt'}), 500
...
def update_prompt(prompt_id):
    try:
        ...
        return jsonify({'success': False, 'error': 'An internal error occurred while updating prompt'}), 500
...
def delete_prompt(prompt_id):
    try:
        ...
        return jsonify({'success': False, 'error': 'An internal error occurred while deleting prompt'}), 500
...
def set_default_prompt(prompt_id):
    try:
        ...
        return jsonify({'success': False, 'error': 'An internal error occurred while setting default prompt'}), 500
...
def get_webhook_config():
    ...
    try:
        ...
        return jsonify({'error': 'An internal error occurred while fetching webhook config'}), 500
...
def update_webhook_config():
    ...
    try:
        ...
        return jsonify({'error': 'An internal error occurred while updating webhook config'}), 500
...
def get_summary_runs():
    ...
    try:
        ...
        return jsonify({'success': False, 'error': 'An internal error occurred while fetching summary runs'}), 500